    ...
    try:
        for index, image_path in enumerate(images):
            ...
            if origin_writer is None:
                ...
                origin_writer = cv2.VideoWriter(str(origin_video_path), fourcc, fps, origin_frame_size)
            ...
            if adjust_writer is None:
                ...
                adjust_writer = cv2.VideoWriter(str(adjust_video_path), fourcc, fps, adjust_frame_size)
